...
if __name__=='__main__':
    ...
    model.add(SpectralConv2D_T(filters=2,kernel_size=3,use_bias=use_bias,activation="relu",**parameters))
    model.add(tf.keras.layers.MaxPooling2D((2,2))) 


    model.add(tf.keras.layers.Flatten())

    model.add(Spectral(1000, **spectral_config, activation=None))
    ...
    print("Precessus termine avec succes")
